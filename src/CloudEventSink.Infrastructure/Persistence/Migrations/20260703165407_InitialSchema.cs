...
namespace CloudEventSink.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretLastFour = table.Column<string>(
                        type: "character varying(8)",
                        maxLength: 8,
                        nullable: false
                    ),
                    IpAllowlist = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecVersion = table.Column<string>(
                    ...
                    EventSource = table.Column<string>(
                        type: "character varying(2048)",
                        maxLength: 2048,
                        nullable: true
                    ),
                    ...
                    DataContentType = table.Column<string>(
                        type: "character varying(256)",
                        maxLength: 256,
                        nullable: true
                    ),
                    TimeUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RootNodeJson = table.Column<string>(type: "jsonb", nullable: false),
                    SampleCount = table.Column<long>(type: "bigint", nullable: false),
                    FirstSeenUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_schemas_sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade
            ...
            migrationBuilder.CreateIndex(
                name: "IX_events_SourceId_EventType",
                table: "events",
                columns: new[] { "SourceId", "EventType" }
            );

            migrationBuilder.CreateIndex(
                name: "IX_events_SourceId_ReceivedAtUtc",
                table: "events",
                columns: new[] { "SourceId", "ReceivedAtUtc" }
            );

            migrationBuilder.CreateIndex(
                name: "IX_schemas_SourceId_EventType",
                table: "schemas",
                columns: new[] { "SourceId", "EventType" },
                unique: true
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "schemas");
